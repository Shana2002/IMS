            ...
            if self.var_type.get()=="Box" :
                ...
                if get==1:   
                    ...
                    for row in self.cart_list:
                        if self.var_pname.get()==row[1] and self.var_loc.get()==row[0]:
                            present='yes'
                            break
                        index_+=1
                    if present=='yes':
                        ...
                        if op==True:
                            if self.var_qty.get()=="0":
                                ...
                                qty1=(int(self.var_qty.get())*int(self.var_nops.get()))
                                #loc,pname,totqty,uprice,price_cal,nop,w,p,c,l,bol
                                self.cart_list[index_][0]=self.var_loc.get()
                                self.cart_list[index_][2]=qty1
...
{str("="*47)}
    ...
    def excel(self):
        ...
        worksheet.write('C5',"     0726153040",textformat)
        worksheet.write('C6',"     0777148851",textformat)

        worksheet.write('E1',"Branches",bold_font)
        worksheet.write('E2',"588A,Galle Road,",textformat)
        worksheet.write('E3',"Panadura",textformat)
        worksheet.write('E4',"TEl: 0726153040",textformat)
        worksheet.write('E5',"     0726153040",textformat)
        worksheet.write('E6',"     0777148851",textformat)
